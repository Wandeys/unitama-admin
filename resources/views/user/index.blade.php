<x-app>
    ...
    <div class="card shadow p-3">
        ...
        <div class="table-responsive">
            <table class="table table-bordered border-primary table-hover w-100" id="data-table">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                ...
                                <a class="btn btn-warning btn-sm " href="{{ route('user.edit', $user) }}"
                                    role="button"><i class='bx bxs-edit-alt'></i></a>

                                <button type="button" class="btn btn-danger btn-sm btn-delete" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal" data-route="{{ route('user.destroy', $user) }}">
